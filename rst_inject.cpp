// ============================================================
// rst_inject.cpp — send forged TCP RST to kill a session
// ------------------------------------------------------------
// Compile: clang++ -std=c++17 -O2 -o rst_inject rst_inject.cpp
// Usage:   sudo ./rst_inject <src_ip> <dst_ip> <sport> <dport> <seq>
// ============================================================
